...
- [Use case 1](./uc1.md): **Laser powder bed fusion L-PBF** .
- [Use case 2](./uc2.md): **Screen printing of solid oxide fuel cells** .
- [Use case 3](./uc3.md): **Nano-particle production and catalyst testing** .
- [Use case 4](./uc4.md): **Ceramic injection moulding for medical applications** .
- [Use case 5](./uc5.md): **Printing of Photovoltaic Thin Films** .
- [Use case 6](./uc6.md): **MatCalc demo** .
...
<br>
<br>
<img src="../\_static/img/ucs/uc_impl/RestAPI.PNG" width="100%"    >
<br>
<br>
